...
See the [grading page](#badgecounts) for how different badges factor into your grad
::::::::


To plan your time, I recommend expecting the following:
- 30 minutes, twice per week for [prepare work](#badges:procedure:experience) (typically not this much). 
- [1.5(review)-3(practice)](#badges:procedure:rp) hours, twice per week for the dated badges (including revisions). 


For each [explore](#badges:procedure:explore) : 
- 30 min for proposal
- 7 hours for the project

For each [build](#badges:procedure:builld): 
