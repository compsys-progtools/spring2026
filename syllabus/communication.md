...
Announcements will be made via {term}`GitHub` Release. You can view them [online in the releases page](https://github.com/compsys-progtools/spring2026/releases) or you can get notifications by watching the {term}`repository`. To sign up to watch, choose "Releases" under custom [see GitHub docs for instructions with screenshots](https://docs.github.com/en/account-and-profile/managing-subscriptions-and-notifications-on-github/setting-up-notifications/configuring-notifications#configuring-your-watch-settings-for-an-individual-repository). You can choose {term}`GitHub` only or turn on e-mail notifications [from the notification settings page](https://github.com/settings/notifications). Github also has a mobile app, if that helps you. 
...
```
put this on a {term}`branch` called `watch_community_badge` and title your PR "Community-Watch" and request a review from `@brownsarahm`
````
:::::::
...
```{important}
You can only see them if you are a "member" of the organization. To join, make sure that you have completed Lab 0. If you need the link still after the second class, email Dr. Brown. 
```
