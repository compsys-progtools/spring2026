...
On BrightSpace, you will find links to other resources, this site and others. 
Any links that are for private discussion among those enrolled in the course 
will be available only from Brightspace.

:::{attention}
Brightspace will **not** be our primary tool, just a place to distribute things to start the semester
:::
...
We will use this for in-class chatting and in-class understanding checks.
