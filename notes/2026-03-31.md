...
### Do you think that the heights we have hit now with computers is what the forefathers imagined?

It might be what some imaginged, but others definitely wanted more things to be free and open source. 

### How was there enough technolgy to make tvs back in the day but yet computers were huge and not that advanced?

TVs also used vacuum tubes and were also pretty big.  Additionally, the content the TV showed was analog. 

###  ow much farther do you think we can push memory and overal storage for personal computers? Is there a limit we will hit? 

I don't have a good answer for this, but it is a good explore badge topic. 

### Are there more computer history museums beyond the ones in North Kingstown and California?

A [wikipedia article](https://en.wikipedia.org/wiki/List_of_computer_museums) has  tabulated a large global list. 

### How much more can computers improve? is there a limit, and are we approaching it?

There are limits in some aspects, for example, Moore's Law, which said the number of transistors would double every two years, [may be over](https://cap.csail.mit.edu/death-moores-law-what-it-means-and-what-might-fill-gap-going-forward). We can't make things smaller, past a certain point, but other changes could happen.  